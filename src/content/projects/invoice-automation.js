const lesson = {
  titleKo: '청구서 자동 처리 시스템',
  titleEn: 'Invoice Processing System',
  contentKo: `# 청구서 자동 처리 시스템
...
- 실시간 미지급금 현황 파악 가능
- 감사 추적(audit trail)을 위한 전 과정 로그 기록`,
  contentEn: `# Invoice Processing System
...
- Full process logging for audit trail compliance`,
};
