const lesson = {
  titleKo: 'VBA 고급 자동화',
  titleEn: 'Advanced VBA Automation',
  contentKo: `# VBA 고급 자동화
...
> **실무 팁**: 대량 데이터 처리 시 \`Application.ScreenUpdating = False\`로 화면 갱신을 멈추면 속도가 크게 향상됩니다.`,
  contentEn: `# Advanced VBA Automation
...
> **Pro Tip**: Set \`Application.ScreenUpdating = False\` before processing large datasets to dramatically improve performance.`,
};
