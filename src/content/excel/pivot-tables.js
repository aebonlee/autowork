...
> **실무 팁**: 원본 데이터를 "표(Table)"로 변환하면 데이터 추가 시 피벗 범위가 자동 확장됩니다.`,
  contentEn: `# Pivot Tables Mastery
...
> **Pro Tip**: Convert source data to a Table (Ctrl+T) so the pivot range auto-expands when new rows are added.`,
};
