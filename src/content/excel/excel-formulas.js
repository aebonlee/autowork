const lesson = {
  titleKo: '핵심 Excel 수식 마스터',
  titleEn: 'Master Essential Excel Formulas',
  contentKo: `# 핵심 Excel 수식 마스터
...
> **실무 팁**: VLOOKUP 대신 INDEX/MATCH를 익혀두면 열 삽입/삭제에도 수식이 깨지지 않습니다.`,
  contentEn: `# Master Essential Excel Formulas
...
> **Pro Tip**: Prefer INDEX/MATCH over VLOOKUP -- it won't break when columns are inserted or deleted.`,
};
