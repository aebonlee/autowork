const lesson = {
  titleKo: '파일/폴더 자동 관리',
  titleEn: 'File & Folder Automation',
  contentKo: `## 파일과 폴더를 Python으로 자동 관리하기
...
- \`pip install watchdog\`로 설치 후 사용하세요.`,
  contentEn: `## Automate File & Folder Management with Python
...
- Install with \`pip install watchdog\` before use.`,
};
