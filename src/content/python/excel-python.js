const lesson = {
  titleKo: 'Python으로 Excel 다루기',
  titleEn: 'Excel with Python',
  contentKo: `## Python으로 엑셀 파일 자동화하기
...
- 대용량 데이터에는 **pandas**가 효율적이고, 세부 서식은 **openpyxl**이 적합합니다.`,
  contentEn: `## Automate Excel Files with Python
...
- Use **pandas** for large datasets; use **openpyxl** for fine-grained formatting.`,
};
