const lesson = {
  titleKo: '데이터 시각화 자동화',
  titleEn: 'Automated Data Visualization',
  contentKo: `# 데이터 시각화 자동화
...
- PDF, PNG, HTML 다양한 형식으로 자동 내보내기`,
  contentEn: `# Automated Data Visualization
...
- Export in multiple formats: PDF, PNG, HTML`,
};
