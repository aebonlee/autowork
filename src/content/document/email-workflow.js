const lesson = {
  titleKo: '이메일 워크플로우',
  titleEn: 'Email Workflow Automation',
  contentKo: `# 이메일 워크플로우 자동화
...
- **Python imaplib**: 커스텀 이메일 처리`,
  contentEn: `# Email Workflow Automation
...
- **Python imaplib**: Custom email processing`,
};
