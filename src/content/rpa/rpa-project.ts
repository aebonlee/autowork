const lesson = {
  titleKo: 'RPA 프로젝트 설계',
  titleEn: 'RPA Project Design',
  contentKo: `## RPA 프로젝트 수명주기
...
- 정기적인 셀렉터 점검 및 업데이트
- 업무 변경 시 PDD/SDD 문서 동기화 필수`,
  contentEn: `## RPA Project Lifecycle
...
- Keep PDD/SDD documents in sync with process changes`,
};
