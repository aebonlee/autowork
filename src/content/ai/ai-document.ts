const lesson = {
  titleKo: 'AI 문서 처리',
  titleEn: 'AI Document Processing',
  contentKo: `## AI 문서 처리 자동화
...
> 팁: 대량 문서 처리 시 rate limit을 고려하여 지연(delay)을 추가하세요.`,
  contentEn: `## AI Document Processing Automation
...
> Tip: Add delays for batch processing to respect rate limits.`,
};
