const lesson = {
  titleKo: 'Claude API 활용',
  titleEn: 'Using Claude API',
  contentKo: `## Anthropic API 시작하기
...
- **스트리밍**: \`stream: true\` 대신 \`.stream()\` 메서드 사용`,
  contentEn: `## Getting Started with Anthropic API
...
- **Streaming**: Uses \`.stream()\` method instead of \`stream: true\``,
};
