const lesson = {
  titleKo: '실전 자동화 시나리오',
  titleEn: 'Real-World Automation Scenarios',
  contentKo: `# 실전 자동화 시나리오
...
- 민감한 데이터는 암호화 및 접근 제어 설정`,
  contentEn: `# Real-World Automation Scenarios
...
- Encrypt sensitive data and configure access controls`,
};
