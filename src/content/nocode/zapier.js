const lesson = {
  titleKo: 'Zapier 자동화',
  titleEn: 'Zapier Automation',
  contentKo: `# Zapier 자동화
...
- Formatter 액션으로 날짜/텍스트 변환 가능`,
  contentEn: `# Zapier Automation
...
- Use Formatter actions for date/text transformations`,
};
