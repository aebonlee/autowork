      ...
      <div className="auth-container">
        <div className="auth-card">
          <div className="auth-header">
            <div className="auth-logo"><span style={{ color: 'var(--primary-blue)' }}>Auto</span>Work</div>
          ...
          <form className="auth-form" onSubmit={handleSubmit}>
            ...
            <input className="form-input" type="password" placeholder={t('auth.password')} value={password} onChange={e => setPassword(e.target.value)} required />
