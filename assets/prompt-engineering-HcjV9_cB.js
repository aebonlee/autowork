const t={titleKo:"프롬프트 엔지니어링",titleEn:"Prompt Engineering",contentKo:`## 프롬프트 엔지니어링이란?
...
- 한 번에 너무 많은 요청 → 작업을 분리하여 요청하세요`,contentEn:`## What is Prompt Engineering?
...
- Too many requests at once → Break tasks into separate prompts`};export{t as default};
