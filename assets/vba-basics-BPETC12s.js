const e={titleKo:"VBA 기초 프로그래밍",titleEn:"VBA Basic Programming",contentKo:`# VBA 기초 프로그래밍
...
> **실무 팁**: 코드 상단에 \`Option Explicit\`을 추가하면 변수 선언을 강제하여 오타 버그를 예방합니다.`,contentEn:`# VBA Basic Programming
...
> **Pro Tip**: Add \`Option Explicit\` at the top of every module to enforce variable declaration and catch typos.`};export{e as default};
