const e={titleKo:"HR 업무 자동화",titleEn:"HR Task Automation",contentKo:`# HR 업무 자동화
...
- 예외 상황(특별 휴가, 경조사)에 대한 수동 처리 경로 확보`,contentEn:`# HR Task Automation
...
- Maintain manual processing paths for exceptions`};export{e as default};
