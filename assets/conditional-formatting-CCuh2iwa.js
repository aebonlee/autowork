const t={titleKo:"조건부 서식과 데이터 유효성",titleEn:"Conditional Formatting & Validation",contentKo:`# 조건부 서식과 데이터 유효성
...
> **실무 팁**: 드롭다운 목록의 원본을 별도 시트에 관리하면 유지보수가 편리합니다.`,contentEn:`# Conditional Formatting & Validation
...
> **Pro Tip**: Store dropdown source lists on a separate sheet for easier maintenance.`};export{t as default};
