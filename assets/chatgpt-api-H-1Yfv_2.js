const e={titleKo:"ChatGPT API 활용",titleEn:"Using ChatGPT API",contentKo:`## OpenAI API 시작하기
...
- **보안**: API 키를 절대 클라이언트 코드에 노출하지 마세요`,contentEn:`## Getting Started with OpenAI API
...
- **Security**: Never expose API keys in client-side code`};export{e as default};
