const t={titleKo:"Python 환경 설정",titleEn:"Python Environment Setup",contentKo:`## Python 설치 및 개발 환경 구성
...
- 프로젝트마다 가상 환경을 만드는 것이 **베스트 프랙티스**입니다.`,contentEn:`## Installing Python & Setting Up Your Dev Environment
...
- Creating a virtual environment per project is a **best practice**.`};export{t as default};
