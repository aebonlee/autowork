const t={titleKo:"문서 템플릿 자동화",titleEn:"Document Template Automation",contentKo:`# 문서 템플릿 자동화
...
- 출력 전 데이터 유효성 검사를 반드시 수행하세요`,contentEn:`# Document Template Automation
...
- Always validate data before rendering output`};export{t as default};
