const e={titleKo:"AI 워크플로우 구축",titleEn:"Building AI Workflows",contentKo:`## AI 워크플로우란?
...
> 팁: 간단한 작업부터 시작하고, 점진적으로 복잡한 워크플로우를 구축하세요.`,contentEn:`## What is an AI Workflow?
...
> Tip: Start with simple tasks and gradually build more complex workflows.`};export{e as default};
