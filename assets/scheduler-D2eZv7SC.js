const e={titleKo:"작업 스케줄링",titleEn:"Task Scheduling",contentKo:`## Python 작업 스케줄링
...
- 운영 환경에서는 OS 레벨 스케줄러와 함께 사용하세요.`,contentEn:`## Task Scheduling with Python
...
- In production, combine with OS-level schedulers for reliability.`};export{e as default};
