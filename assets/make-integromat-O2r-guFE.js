const e={titleKo:"Make(Integromat) 활용",titleEn:"Make (Integromat)",contentKo:`# Make(Integromat) 활용
...
- JSON, XML 등 복잡한 데이터 구조 처리 용이`,contentEn:`# Make (Integromat)
...
- Handles complex data structures (JSON, XML) with ease`};export{e as default};
