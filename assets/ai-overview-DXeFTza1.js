const e={titleKo:"AI 자동화 개요",titleEn:"AI Automation Overview",contentKo:`## AI 자동화란?
...
> 팁: 작은 모델로 먼저 테스트하고, 품질이 부족할 때만 큰 모델로 전환하세요.`,contentEn:`## What is AI Automation?
...
> Tip: Start with smaller models and only upgrade when quality is insufficient.`};export{e as default};
