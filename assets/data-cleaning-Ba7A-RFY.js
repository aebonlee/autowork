const e={titleKo:"데이터 정제 자동화",titleEn:"Automated Data Cleaning",contentKo:`# 데이터 정제 자동화
...
## 주의사항
- 원본 데이터는 반드시 보존하세요
- 정제 이력을 로그로 남겨 추적 가능하게 하세요`,contentEn:`# Automated Data Cleaning
...
- Log cleaning history for traceability`};export{e as default};
