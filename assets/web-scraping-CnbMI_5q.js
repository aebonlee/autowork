const t={titleKo:"웹 스크래핑 기초",titleEn:"Web Scraping Basics",contentKo:`## Python 웹 스크래핑 입문
...
- 동적 페이지는 \`selenium\` 또는 \`playwright\` 사용을 권장합니다.`,contentEn:`## Introduction to Web Scraping with Python
...
- For dynamic pages, consider \`selenium\` or \`playwright\`.`};export{t as default};
