const e={titleKo:"데이터 파이프라인",titleEn:"Data Pipeline Design",contentKo:`# 데이터 파이프라인 설계
...
- 모니터링과 알림으로 파이프라인 건강 상태 추적`,contentEn:`# Data Pipeline Design
...
- Track pipeline health with monitoring and alerts`};export{e as default};
