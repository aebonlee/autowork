const e={titleKo:"이메일 자동화",titleEn:"Email Automation",contentKo:`## Python 이메일 자동 발송
...
- Gmail은 **앱 비밀번호** 설정이 필요합니다.`,contentEn:`## Automated Email Sending with Python
...
- Gmail requires an **App Password** to be configured.`};export{e as default};
